...
function getOS() {
    var userAgent = window.navigator.userAgent,
        platform = window.navigator.platform, //|| window.navigator?.userAgent?.platform.toString(),
 ...
 * @returns {float}
 */
function getRandomFloat(min: any, max: any, decimals: number) {
    min = parseFloat(min)
    max = parseFloat(max)
 ...
 * @returns {number} 
 */
function BNToNumber(number: number, decimals = 18) {
 ...
 * @returns {string}
 */
function BNFormat(bigNumber: BigNumber) {
